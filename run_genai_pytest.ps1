...
$env:GENAI_ROOT_DIR = "C:\Users\openvino-ci-88\xiping\profiling_qwen2b_vl_instruction\openvino.genai\install\python"
$env:PYTHONPATH = "$env:GENAI_ROOT_DIR;$env:PYTHONPATH"
$env:PATH = "$env:GENAI_ROOT_DIR\..\runtime\bin\intel64\Debug;$env:PATH"
