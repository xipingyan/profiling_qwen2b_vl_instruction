...
$env:PATH = "$env:GENAI_ROOT_DIR\\..\\runtime\\bin\\intel64\\Debug;$env:PATH;$env:CUSTOM_VIT_PATH"

$env:PATH = "C:\\ov_task\\profiling_qwen2b_vl_instruction\\example_ov_cpp\\build\\Debug;$env:PATH;"
